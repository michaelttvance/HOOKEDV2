...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Hooked — Tow Dispatch" },
      { name: "description", content: "Modern tow dispatch board, driver app, and billing in one place." },
      { property: "og:title", content: "Hooked — Tow Dispatch" },
      { property: "og:description", content: "Modern tow dispatch board, driver app, and billing in one place." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "Hooked — Tow Dispatch" },
      { name: "twitter:description", content: "Modern tow dispatch board, driver app, and billing in one place." },
    ],
    styles: [
      { children: appCss },
    ],
